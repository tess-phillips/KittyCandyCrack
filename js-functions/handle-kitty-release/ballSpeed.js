...
function ballSpeed() {
  ...
  if (gameState.timePressed >= 2000) {
    //hold for long so speed is fast
    gameState.speed_ = 3;
  } else if (gameState.timePressed >= 500) {
    //hold not long so speed slow
    gameState.speed_ = 2;
  } else {
    // slow version (just a click)
    gameState.speed_ = 1;
  }
...
// IM NOT SURE I USE THIS ANYWHERE, DIVE INTO THIS LATER
export { ballSpeed };
